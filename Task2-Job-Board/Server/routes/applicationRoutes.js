...
router.get('/getApplication', protect, getApplicationsByUser);  // Protect this route
router.put('/updateApplication/:applicationId', protect, updateApplicationStatus);  // Employer updates application status
