  ...
  return (
    <header className="shadow">
      ...
      <div className="flex justify-center ">
        <div className="flex px-4 md:px-12 w-full lg:px-24 justify-between items-center lg:w-[90%] max-w-[1920px]">
          <img
          ...
          <div className="flex gap-2">
            <Link
              to={"/signin"}
              className="rounded px-3 py-2 border-2 text-blue-600"
            >
              Sign In
            </Link>
            <Link to={"/"} className="rounded px-3 py-2 text-white bg-blue-600">
              Post A Job
            </Link>
          </div>
        </div>
