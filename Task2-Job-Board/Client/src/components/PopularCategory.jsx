            ...
            <div className="px-4 md:px-12 lg:px-24 flex flex-col gap-8 w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="flex items-center px-4 py-3 rounded flex-row bg-gray-50 gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-lg md:text-xl">Graphics & Design</h3>
                    ...
                    <div className="flex items-center px-4 py-3 rounded flex-row bg-gray-50 gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-lg md:text-xl">Code & Programing</h3>
                            <p>357 Open position</p>
                        </div>
                    </div>
                    <div className="flex items-center px-4 py-3 rounded flex-row bg-gray-50 gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-lg md:text-xl">Digital Marketing</h3>
                            <p>357 Open position</p>
                        </div>
                    </div>
                    <div className="flex items-center px-4 py-3 rounded flex-row bg-gray-50 gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-lg md:text-xl">Video & Animation</h3>
                            <p>357 Open position</p>
                        </div>
                    </div>
                    <div className="flex items-center px-4 py-3 rounded flex-row bg-gray-50 gap-4">
                    ...
                    <div className="flex items-center px-4 py-3 rounded flex-row bg-gray-50 gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-lg md:text-xl">Account & Finance</h3>
                            <p>357 Open position</p>
                        </div>
                    </div>
                    <div className="flex items-center px-4 py-3 rounded flex-row bg-gray-50 gap-4">
