...
const Signup = () => {
    ...
    return (
        <section className="container flex justify-center min-h-screen">
            <div className="flex flex-col items-start min-w-52 gap-6 pb-8 text-left h-full">
                <img src={logo} alt="Jobify" className="w-32 h-32" />
                <div className="flex flex-col gap-3">
                    <div className="flex flex-col gap-3">
                        <h1 className="text-4xl font-semibold">Create account.</h1>
                        <p className="text-gray-500">Already have an account? <a href="/login" className="text-blue-500 font-semibold">Log In</a></p>
                    </div>
                    <div className="flex flex-col p-3 gap-2 rounded-md bg-gray-200 items-center">
                        <p>CREATE ACCOUNT AS A</p>
                        <div className="flex">
                            <button onClick={(e) => setUserType(e.target.value)} value={"candidate"} className={`px-16 py-2 text-xl flex items-center gap-2 font-semibold rounded ${userType === "candidate" ? "bg-[#042852] text-white" : ""}`}><RxAvatar />Candidate</button>
                            <button onClick={(e) => setUserType(e.target.value)} value={"employer"} className={`px-16 py-2 text-xl flex items-center gap-2 font-semibold rounded ${userType === "employer" ? "bg-[#042852] text-white" : ""}`}><PiBuildingOfficeBold />Employer</button>
                        </div>
                    </div>
                    <form className="grid grid-cols-2 gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <select name="gender" value={genderValue} onChange={(e) => setGenderValue(e.target.value)} className="text-black rounded" id="gender">
                        ...
                        <div className="flex items-center col-span-2 gap-2">
                            ...
                            <label htmlFor="terms" className="text-gray-500">I agree to the <a href="/terms" className="text-blue-500 font-semibold">terms and conditions</a></label>
                        </div>
                        <button className="py-3 text-white col-span-2 bg-[#0a65cc] rounded font-semibold flex items-center justify-center gap-2">Create Account<IoArrowForward className="text-xl" /></button>
                    </form>
                    <p className="col-span-2 text-center text-neutral-400">OR</p>
                    <div className="grid gap-2 w-full grid-cols-2 col-span-2">
                        <button className="py-2 border-2 border-neutral-200 text-lg text-neutral-500 shadow-sm col-span-1 rounded-md flex items-center justify-center gap-2"><FaFacebookF className="text-blue-700 text-xl" />Sign up with Facebook</button>
                        <button className="py-2 border-2 border-neutral-200 text-lg text-neutral-500 shadow-sm col-span-1 rounded-md flex items-center justify-center gap-2"><FcGoogle className="text-xl" />Sign up with Google</button>
                    </div>
                </div>
            </div>
        </section>
